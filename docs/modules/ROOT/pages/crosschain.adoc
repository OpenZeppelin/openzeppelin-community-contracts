...
For more details of how the duplex gateway works, see xref:crosschain.adoc#axelar-network[how to send and receive messages with the  Axelar Network] below
