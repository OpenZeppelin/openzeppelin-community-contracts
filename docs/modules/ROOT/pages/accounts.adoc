...
* xref:api:utils.adoc#SignerWebAuthn[`SignerWebAuthn`]: Validates signatures using WebAuthn authentication assertions, leveraging P256 public keys for both WebAuthn and raw P256 signature validation.
