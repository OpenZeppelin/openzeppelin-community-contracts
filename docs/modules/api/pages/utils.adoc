...
:values: pass:normal[xref:#EnumerableSetExtended-values-struct-EnumerableSetExtended-StringSet-uint256-uint256-[`++values++`]]
...
:values: pass:normal[xref:#EnumerableSetExtended-values-struct-EnumerableSetExtended-BytesSet-uint256-uint256-[`++values++`]]
...
[.contract-item]
[[EnumerableSetExtended-values-struct-EnumerableSetExtended-StringSet-uint256-uint256-]]
==== `[.contract-item-name]#++values++#++(struct EnumerableSetExtended.StringSet set, uint256 start, uint256 end) → string[]++` [.item-kind]#internal#
...
[.contract-item]
[[EnumerableSetExtended-values-struct-EnumerableSetExtended-BytesSet-uint256-uint256-]]
==== `[.contract-item-name]#++values++#++(struct EnumerableSetExtended.BytesSet set, uint256 start, uint256 end) → bytes[]++` [.item-kind]#internal#
