...
:areValidNSignaturesNow: pass:normal[xref:#ERC7913Utils-areValidNSignaturesNow-bytes32-bytes---bytes---function--bytes--view-returns--bytes32--[`++areValidNSignaturesNow++`]]
:areValidNSignaturesNow: pass:normal[xref:#ERC7913Utils-areValidNSignaturesNow-bytes32-bytes---bytes---[`++areValidNSignaturesNow++`]]
...
* `++areValidNSignaturesNow(hash, signers, signatures, signerId)++`
* `++areValidNSignaturesNow(hash, signers, signatures)++`
...
[.contract-item]
[[ERC7913Utils-areValidNSignaturesNow-bytes32-bytes---bytes---function--bytes--view-returns--bytes32--]]
==== `[.contract-item-name]#++areValidNSignaturesNow++#++(bytes32 hash, bytes[] signers, bytes[] signatures, function (bytes) view returns (bytes32) signerId) → bool++` [.item-kind]#internal#
...
[.contract-item]
[[ERC7913Utils-areValidNSignaturesNow-bytes32-bytes---bytes---]]
==== `[.contract-item-name]#++areValidNSignaturesNow++#++(bytes32 hash, bytes[] signers, bytes[] signatures) → bool++` [.item-kind]#internal#

Overload of {areValidNSignaturesNow} that uses the `keccak256` as the `signerId` function.
