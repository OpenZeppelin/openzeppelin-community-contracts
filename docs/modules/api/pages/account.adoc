...
:ERC7579InvalidExecution: pass:normal[xref:#ERC7579Executor-ERC7579InvalidExecution--[`++ERC7579InvalidExecution++`]]
...
==== `[.contract-item-name]#++_validateExecution++#++(address account, bytes32 salt, bytes32 mode, bytes data) → bool valid, bytes executionCalldata++` [.item-kind]#internal#

Check if the caller is authorized to execute operations.
...
[.contract-item]
[[ERC7579Executor-ERC7579InvalidExecution--]]
==== `[.contract-item-name]#++ERC7579InvalidExecution++#++()++` [.item-kind]#error#

Thrown when the execution is invalid. See {_validateExecution} for details.
...
:ERC7579ExecutorUnauthorizedCancellation: pass:normal[xref:#ERC7579DelayedExecutor-ERC7579ExecutorUnauthorizedCancellation--[`++ERC7579ExecutorUnauthorizedCancellation++`]]
:ERC7579ExecutorUnauthorizedSchedule: pass:normal[xref:#ERC7579DelayedExecutor-ERC7579ExecutorUnauthorizedSchedule--[`++ERC7579ExecutorUnauthorizedSchedule++`]]
...
* `++ERC7579ExecutorUnauthorizedCancellation()++`
* `++ERC7579ExecutorUnauthorizedSchedule()++`
...
==== `[.contract-item-name]#++_validateExecution++#++(address, bytes32, bytes32, bytes data) → bool valid, bytes executionCalldata++` [.item-kind]#internal#
...
==== `[.contract-item-name]#++_validateCancel++#++(address account, bytes32, bytes32, bytes) → bool++` [.item-kind]#internal#

Whether the caller is authorized to cancel operations.
...
==== `[.contract-item-name]#++_validateSchedule++#++(address account, bytes32, bytes32, bytes) → bool++` [.item-kind]#internal#

Whether the caller is authorized to schedule operations.
By default, this checks if the caller is the account itself. Derived contracts can
override this to implement custom authorization logic.
...
[.contract-item]
[[ERC7579DelayedExecutor-ERC7579ExecutorUnauthorizedCancellation--]]
==== `[.contract-item-name]#++ERC7579ExecutorUnauthorizedCancellation++#++()++` [.item-kind]#error#

The operation is not authorized to be canceled.

[.contract-item]
[[ERC7579DelayedExecutor-ERC7579ExecutorUnauthorizedSchedule--]]
==== `[.contract-item-name]#++ERC7579ExecutorUnauthorizedSchedule++#++()++` [.item-kind]#error#

The operation is not authorized to be scheduled.
