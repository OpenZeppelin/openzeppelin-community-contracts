...
:executeUserOp: pass:normal[xref:#AccountCore-executeUserOp-struct-PackedUserOperation-bytes32-[`++executeUserOp++`]]
...
[.contract]
[[AccountCore]]
=== `++AccountCore++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.0.1/contracts/account/draft-AccountCore.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/account/draft-AccountCore.sol";
```
...
[.contract-item]
[[AccountCore-executeUserOp-struct-PackedUserOperation-bytes32-]]
==== `[.contract-item-name]#++executeUserOp++#++(struct PackedUserOperation userOp, bytes32)++` [.item-kind]#public#
...
[.contract]
[[Account]]
=== `++Account++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.0.1/contracts/account/draft-Account.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/account/draft-Account.sol";
```
...
=== `++AccountSignerERC7702++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.0.1/contracts/account/extensions/draft-AccountSignerERC7702.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/account/extensions/draft-AccountSignerERC7702.sol";
```
