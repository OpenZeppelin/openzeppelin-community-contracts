...
==== `[.contract-item-name]#++DOMAIN_FIELDS++#++() → uint256++` [.item-kind]#public#

[.contract-item]
[[ZKEmailUtils-DOMAIN_BYTES-uint256]]
==== `[.contract-item-name]#++DOMAIN_BYTES++#++() → uint256++` [.item-kind]#public#

[.contract-item]
[[ZKEmailUtils-COMMAND_FIELDS-uint256]]
==== `[.contract-item-name]#++COMMAND_FIELDS++#++() → uint256++` [.item-kind]#public#

[.contract-item]
[[ZKEmailUtils-COMMAND_BYTES-uint256]]
==== `[.contract-item-name]#++COMMAND_BYTES++#++() → uint256++` [.item-kind]#public#
