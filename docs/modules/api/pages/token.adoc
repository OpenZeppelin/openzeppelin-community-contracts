...
:IERC7943Fungible-Frozen: pass:normal[xref:interfaces.adoc#IERC7943Fungible-Frozen-address-uint256-[`IERC7943Fungible.Frozen`]]
...
:canTransact: pass:normal[xref:#ERC20uRWA-canTransact-address-[`++canTransact++`]]
