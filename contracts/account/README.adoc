 ...
 * {RoleAccount}: An account bound to a role of an `IAccessManager` (through {SignerRole}), acting on behalf of the current members of that role for both ERC-1271 signatures and ERC-7821 batched execution.
