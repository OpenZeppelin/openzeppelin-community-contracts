 ...
 * {SignerRole}: Implementation of an https://docs.openzeppelin.com/contracts/5.x/api/utils/cryptography#AbstractSigner[AbstractSigner] whose authority is delegated to the members of a role tracked by an `IAccessManager`.
